...
## Open Source
**Apache Fineract** - 20+ merged PRs since November 2025.
...
Other contributions: PostgreSQL schema fixes, removal of stale report data, fixing undo and adjust transactions for Fixed Deposit accounts, batching N+1 database queries across several services, hardening Feign method names across five modules, and fixing a NullPointerException in delinquency reporting.
